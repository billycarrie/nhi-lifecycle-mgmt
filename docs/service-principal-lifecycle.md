...
![retailsync-pro-connector Overview](docs/screenshots/sp-retailsync-overview.png)

![API Permissions — User.Read.All Admin Consented](docs/screenshots/sp-retailsync-api-permissions.png)
